...
MOCK_MODULES = [
    ...
    'matplotlib.animation', 'h5py','numpy.ma','matplotlib.cbook']
...
latex_documents = [
  ('index', 'pySAC.tex', u'pySAC Documentation',
...
texinfo_documents = [
  ('index', 'pySAC', u'pySAC Documentation',
   u'Stuart Mumford', 'pySAC', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = u'pySAC'
epub_author = u'Stuart Mumford'
epub_publisher = u'Stuart Mumford'
epub_copyright = u'2013, Stuart Mumford'
