"""
Routines for the writing of GDF files from arbitary and 'SACFile' like arrays
"""
...
__all__ = ['convert_w_3D', 'convert_w_2D', 'write_gdf', 'write_field',
           'write_field_u', 'create_file']
